...
import HeroSectionFarm from '../../../assets/hero-section-farm.svg'
import "../styles/hero_section.css"
import Image_two from '../../../assets/secondImage.svg'
            ...
            <div className="hero_section">
                <div className="navbar_section">
                    <div className="navbar_first">
                        <img src={Logo} alt='cultify-logo'></img>
                    </div>
                ...
                <div className="hero_section_second">
                    <div className="hero_section_inner_one">
                        <div className="hero_section_textone">
                            <p>
                                Invest in Farms with Ease, Seamlessly Connecting You to Agriculture.
                            </p>
                        </div>

                        <div className="hero_section_texttwo">
                            <p>
                        ...
                        <div className='hero_section_get_started'>
                            <button>Get started</button>
                        </div>
                    </div>

                    <div className="hero_section_inner_two">
                        <img src={HeroSectionFarm} alt='farm'></img>
                    </div>
                </div>
                ...
                <div className='about-us'>
                    ...
                    <div className='about-us-inner'>
                        ...
                        <div className='about-us-image'>
                            <img src={Image_two} alt='woman smiling'></img>
                        </div>
