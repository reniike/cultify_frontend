    ...
    <div className="homePageContainer">
      <div className="w-full h-full">
        <nav className="sticky top-0 shadow-lg">
          <div className="w-full h-[80px] flex justify-between items-center px-[56px] bg-white">
            ...
            <div className="flex gap-[10px] justify-center items-center">
              <p className="max-w-xs transition duration-300 ease-in-out hover:scale-110">
                {" "}
                Home{" "}
              </p>
              <p className="max-w-xs transition duration-300 ease-in-out hover:scale-110">
              ...
              <p
                className="rounded-lg border-solid border-[2px] px-4 py-2 max-w-xs transition duration-300 ease-in-out hover:scale-110
              ...
              <p
                className="rounded-lg border-solid border-[2px] max-w-xs transition duration-300 ease-in-out
        ...
        <div className="w-full-[50px] min-h-[100vh] flex justify-center items-center gap-[20px] px-[56px] bg-[#C1DDEB]/20">
          <div className="max-w-[680px]">
            <div>
              <p className="text-[40px] font-bold text-custom-blue ">
                ...
                <div className="text-custom-green inline-block">
                  Seamlessly{" "}
                </div>{" "}
            ...
            <div className="">
              <button
                className="rounded-lg border-solid border-[2px] max-w-xs transition duration-300 ease-in-out
                         hover:scale-110 text-white bg-custom-green px-4 py-2 hover:text-black hover:bg-white hover:border-2 hover:border-black"
                onClick={handleRegistration}
              >
                Get started
              </button>
          ...
          <div className="w-screen mt-[-15px]">
        ...
        <div className="w-full-[50px] min-h-[100vh] flex flex-col justify-center items-center gap-[5px] px-[56px]">
          <div className="mb-[-25px]">
            <h1 className="text-custom-green text-[50px] font-bold">
              About Us
            </h1>
          </div>
          ...
          <div className="flex gap-[20px] justify-center items-center mt-[-50px]">
            ...
            <div className="max-w-[650px] text-[20px]">
              <p className="pl-[40px]">
                ...
                opportunities found within the farming industry. Our
                user-friendly platform empowers you to explore and invest in
                farms with ease, allowing you to participate in the growth of
                this vital sector . Join us today and embark on a journey that
                combines simplicity, speed, and the promise of prosperous farm
                investments.
              </p>
            </div>
          </div>
        ...
        <div className="w-full-[50px] min-h-[100vh] flex flex-col gap-[20px] px-[56px] mt-[10px] bg-[#C1DDEB]/20">
          <div className="justify-center items-center pl-[30%]">
            <h1 className="text-custom-green text-[52px] font-bold">
              Why Choose Cultify
            </h1>
          </div>
          ...
          <div className="">
            <div className="flex gap-[40px] justify-center">
              <div className="bg-white w-[350px] h-[240px] border rounded-lg flex flex-col justify-center items-center">
                <img
                  ...
                  className="ml-4 mt-4"
                ></img>
                <p className="font-bold text-xl ml-4 mt-4 text-center">
                  SIMPLICITY
                </p>
                <p className="text-[20px] text-center mt-3 px-3">
            ...
            <div className="flex gap-[20px] justify-center items-center">
              <div className="bg-white mt-10 w-[350px] h-[240px] border rounded-lg flex flex-col justify-center items-center">
                ...
                <p className="text-[20px] text-center mt-3 px-3 ">
                  Access diverse farms across regions and crops for investment
                  opportunities.{" "}
                </p>
              </div>
              <div className="bg-white  mt-10 w-[350px] h-[240px] border rounded-lg flex flex-col justify-center items-center">
                ...
                <p className="text-[20px] text-center mt-3 px-3">
                  Rely on our dedicated team for prompt and reliable investment
                  assistance.
                </p>
              </div>
            </div>
          ...
          <div className="flex mt-[30px]">
            ...
            <div className="text-[20px] bg-[#C1DDEB]/10 border rounded-lg">
              <p className="pl-[30px] mt-[7%]">
                <div className="mb-[5%]">
                  <span className="font-bold">Explore: </span> Discover diverse
                  farm investment opportunities.
                  <br />
                </div>
                <div className="mb-[5%]">
                  <span className="font-bold">Research: </span>Access detailed
                  information about farms, returns, and risks.
                  <br />
                </div>
                <div className="mb-[5%]">
                  <span className="font-bold">Invest:</span> Choose your desired
                  farm and invest securely.
                  <br />
                </div>
                <div className="mb-[5%]">
                  <span className="font-bold">Track:</span> Monitor your
                  investments and farm progress.
                  <br />
                </div>
                <div className="mb-[5%]">
                  <span className="font-bold">Manage:</span> Easily manage your
                  profile and make adjustments.
                  <br />
                </div>
